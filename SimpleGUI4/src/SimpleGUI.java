...
import com.jgoodies.forms.layout.RowSpec;
		...
		public class SimpleGUI extends JFrame {
			...
			public SimpleGUI() {
			    ...
			    mntmNewMenuItem.setBackground(new Color(216, 191, 216));
			    mnNewMenu.add(mntmNewMenuItem);
			    
			    JMenuItem mntmNewMenuItem_1 = new JMenuItem("House List");
			    mntmNewMenuItem_1.setBackground(new Color(216, 191, 216));
			    mnNewMenu.add(mntmNewMenuItem_1);
			    
			    JMenuItem mntmNewMenuItem_2 = new JMenuItem("Daily Statistcis");
			    mntmNewMenuItem_2.setBackground(new Color(216, 191, 216));
			    mnNewMenu.add(mntmNewMenuItem_2);
			    
			    JMenuItem mntmNewMenuItem_3 = new JMenuItem("Total Statistics");
			    mntmNewMenuItem_3.setBackground(new Color(216, 191, 216));
			    ...
			    spinner.setBounds(138, 58, 34, 26);
			    getContentPane().add(spinner);
			    
			    JLabel lblNewLabel_2 = new JLabel("House number:");
			    lblNewLabel_2.setForeground(Color.DARK_GRAY);
			    lblNewLabel_2.setBounds(41, 63, 97, 16);
